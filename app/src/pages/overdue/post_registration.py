...
#         try:
#             doc_ref = DB.collection('Overdue').add(save_data)  # Firestore에 데이터를 추가
...
#             self.open_overdue_loan_management(save_data)  # 저장된 데이터와 함께 관리 화면 열기
...
#     window = OverduePostRegistrationApp()
#     window.show()
#     sys.exit(app.exec_())